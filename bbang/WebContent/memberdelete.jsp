...
<body>
	<div id="content_logo">
		...
		<div class="content_input">
			<div id="pwUpdate">회원 탈퇴</div>
			
				
	            <table class="contnt-basic">
				
			        		<div class="warnning">
				        			<strong id = "first">사용하고 계신 아이디( <em id="id">${sessionScope.loginUser.id}</em> )는 탈퇴할 경우 재사용 및 복구가 불가능합니다.</strong>
				        			<br>
				        			<span class = "font red">탈퇴한 아이디는 본인과 타인 모두 재사용 및 복구가 불가</span>
				        			<span class = "font">하오니 <br>
				        			신중하게 선택하시기 바랍니다.</span>	 
			        		</div>
			  	       
			  	       
			  	        <div class="warnning">
				        			<strong id = "first">탈퇴 후에도 게시판형 서비스에 등록한 게시물은 그대로 남아 있습니다.</strong>
				        			<br>
				        			<span class = "font"> 게시글 및 댓글은 탈퇴 시 자동 삭제되지 않고 그대로 남아 있습니다.<br>삭제를 원하는 게시글이 있다면 </span>
				        			<span class = "font red">반드시 탈퇴 전 비공개 처리하거나 삭제하시기 바랍니다. </span>
				        			<span class = "font">탈퇴 후에는 회원정보가 삭제되어 본인 여부를 확인할 수 있는 방법이 없어, 게시글을 임의로 삭제해드릴 수 없습니다.</span>	 
			        	</div>
