				...
				*/
				...
				success: function(data){
					if(data.message == "-1") {
						...
						$("#id").parent().next().text("이미 사용중인 아이디 입니다.").css("display", "block").css("color", "#F46665");
						$("#id").select();
						/* $("#id").parent().css("margin-bottom", "30px"); */
						
					} else {
						$("#id").parent().next().text("멋진 아이디네요.").css("display", "block").css("color", "#0000FF");
						$("#pw1").select();
						/* $("#id").parent().css("margin-bottom", "30px"); */
					}
				},
		...
		<div class="content_input">
	            ...
	            <tr>
	                <th><i class="input-info"></i>아이디</th>
			        	<td>
			        		<div>
			        			<input type="text" class="input-text input-text-xl" id="id" name="id" data-valid-name="아이디" data-valid-type="alphaNumeric" placeholder="영문, 숫자 사용가능하며, 6~20자 가능">
			        		</div>
	            ...
	            <table class="contnt-basic2">
						...
						<th><i class="input-info"></i>이름</th>
	              			<td>
	              				<div>
	              				<input type="text" class="input-text" id="name" name="name" maxlength="20"  data-valid-name="이름" >
	              				</div>
	                  			<span class="error">필수정보입니다.</span>
	             			</td>
	           		 </tr>
	                	...
	                	<th><i class="birthday"></i>생년월일</th>
	                        <td>
	                        	<div class="birthday_info">
	                                 ...
	                                 <div class="bir_mm">
	                                    <select id="mm" name = "birmm" data-valid-name="월">
	           ...
	           <hr>
	            <div class="oper">
	            	<a href="index.bizpoll" id="oper01">취소</a>
